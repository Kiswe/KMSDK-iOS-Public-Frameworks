...
- (void)mediaController:(KMMediaViewController * _Nonnull)mediaController playerSwitchingFromStream:(NSString * _Nullable)fromStreamName toStream:(NSString * _Nullable)toStreamName withOrientation:(NSString * _Nullable)withOrientation;
...
typedef SWIFT_ENUM(NSInteger, KMMediaState, open) {
...
- (void)setStreamWithNamed:(NSString * _Nonnull)streamName videoOrientation:(NSString * _Nonnull)videoOrientation;
@end
...
@property (nonatomic, copy) NSArray<Widget *> * _Nonnull widgets;
