...
@interface AVMetadataItem (SWIFT_EXTENSION(KMSDK))
@end


@interface AVPlayer (SWIFT_EXTENSION(KMSDK))
@end
...
- (KMParentViewController * _Nonnull)parentViewControllerWithEventDict:(NSDictionary<NSString *, id> * _Nonnull)eventDict username:(NSString * _Nullable)username;
- (KMParentViewController * _Nonnull)parentViewControllerWithEvent:(Event * _Nonnull)event username:(NSString * _Nullable)username;
@end
...
- (KMMediaViewController * _Nonnull)mediaPlayerControllerWithEventDict:(NSDictionary<NSString *, id> * _Nonnull)eventDict username:(NSString * _Nullable)username;
- (KMMediaViewController * _Nonnull)mediaPlayerControllerWithEvent:(Event * _Nonnull)event username:(NSString * _Nullable)username;
@end
...
+ (NSString * _Nonnull)km_createClipViewControllerWillDismissNotification;
@end
...
@interface UIColor (SWIFT_EXTENSION(KMSDK))
+ (UIColor * _Nonnull)kiswePrimaryRedColor;
+ (UIColor * _Nonnull)kisweGrayOneColor;
+ (UIColor * _Nonnull)kisweGrayTwoColor;
+ (UIColor * _Nonnull)kisweGrayThreeColor;
+ (UIColor * _Nonnull)kisweGrayFourColor;
+ (UIColor * _Nonnull)kisweGrayFiveColor;
+ (UIColor * _Nonnull)kisweGraySixColor;
+ (UIColor * _Nonnull)kisweGraySevenColor;
+ (UIColor * _Nonnull)kisweGrayEightColor;
@end
...
/**
  ...
  \param contentMode The \code
  UIViewContentMode
  \endcode to be applied when resizing image. Either \code
  ...
  Return \code
  UIImage
  \endcode of resized image.
*/
- (UIImage * _Nullable)imageByScalingToSize:(CGSize)newSize contentMode:(UIViewContentMode)contentMode;
/**
  Resize the image to be the required size, stretching it as needed.
  \param newSize The new size of the image.
  ...
  \endcode of resized image.
*/
- (UIImage * _Nullable)imageByScalingToFillSize:(CGSize)newSize;
/**
  ...
  \endcode.
*/
- (UIImage * _Nonnull)imageByCroppingToBounds:(CGRect)bounds;
/**
  ...
  \endcode of resized image.
*/
- (UIImage * _Nonnull)imageByScalingAspectFillSize:(CGSize)newSize;
/**
  ...
  \endcode of resized image.
*/
- (UIImage * _Nonnull)imageByScalingAspectFitSize:(CGSize)newSize;
- (UIImage * _Nonnull)grayScaleImageWithPreserveTransparency:(BOOL)transparent;
/**
...
*/
- (BOOL)isEqualToImage:(UIImage * _Nonnull)image;
@end


@interface UIStoryboard (SWIFT_EXTENSION(KMSDK))
@end
...
@property (nonatomic, setter=setOpaque:) BOOL isOpaque;
...
@protocol WidgetDelegate
- (void (^ _Nullable)(NSDictionary * _Nonnull, void (^ _Nullable)(id _Nullable)))widget:(Widget * _Nonnull)widget handlerForFunctionNamed:(NSString * _Nonnull)functionName;
@end
